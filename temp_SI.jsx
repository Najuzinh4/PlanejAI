...
const SubjectInput = ({ value, onChange, onAdd, placeholder = 'O que você quer estudar?' }) => {
  const onKeyDown = (e) => {
    if (e.key === 'Enter') {
      e.preventDefault();
      onAdd?.();
    ...
    <StyledWrapper>
      <div>
        ...
        <div id="poda">
          ...
          <div id="main">
            <input placeholder={placeholder} type="text" name="text" className="input" value={value} onChange={e => onChange?.(e.target.value)} onKeyDown={onKeyDown} />
            <div id="input-mask" />
            <div id="pink-mask" />
...
const StyledWrapper = styled.div`
  ...
  .border::before {
    ...
    position: absolute; width: 600px; height: 600px; filter: brightness(1.3);
    background-repeat: no-repeat; background-position: 0 0;
  ...
  .darkBorderBg::before {
    ...
    position: absolute; width: 600px; height: 600px; background-repeat: no-repeat; background-position: 0 0;
  ...
  .glow:before {
    content: ""; z-index: -2; text-align: center; top: 50%; left: 50%; transform: translate(-50%, -50%) rotate(60deg);
    position: absolute; width: 999px; height: 999px; background-repeat: no-repeat; background-position: 0 0;
