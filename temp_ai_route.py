...
class PlanRequest(BaseModel):
    subject: str
    hours_per_week: int
    difficulty: str  # e.g., "baixa", "mÃ©dia", "alta"
    goal: str | None = None
...
def generate_plan(request: PlanRequest):
    prompt = (
        "Gere um cronograma de estudo estruturado, com semanas e tarefas diÃ¡rias, "
        "com recomendaÃ§Ãµes de tÃ©cnicas (Pomodoro, revisÃ£o espaÃ§ada) e checkpoints. "
